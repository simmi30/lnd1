...
func TestConstraintsChannelBudget(t *testing.T) {
	...
	const (
		minChanSize = 0
		maxChanSize = btcutil.Amount(btcutil.SatoshiPerBrocoin)
	...
	testCases := []struct {
		...
		// channels.
		{
			...
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 10),
			false,
			0,
			0,
		},
		...
		// threshold.
		{
			[]LocalChannel{
				{
					ChanID:  randChanID(),
					Balance: btcutil.Amount(btcutil.SatoshiPerBrocoin),
				},
				{
					ChanID:  randChanID(),
					Balance: btcutil.Amount(btcutil.SatoshiPerBrocoin),
			...
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 2),
			false,
			0,
			0,
		},
		...
		// limit is 3.
		{
			...
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 9),
			true,
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 4),
			2,
		},
		...
		// channel as the limit is 3.
		{
			[]LocalChannel{
				...
				{
					ChanID:  randChanID(),
					Balance: btcutil.Amount(btcutil.SatoshiPerBrocoin * 3),
				},
			},
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 10),
			true,
			btcutil.Amount(btcutil.SatoshiPerBrocoin * 3),
			1,
		},
		...
		// threshold.
		{
			...
			btcutil.Amount(btcutil.SatoshiPerBrocoin),
			false,
			0,
			0,
		},
